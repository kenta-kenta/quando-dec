                        ...
                        <div class="mt-2 p-4 bg-gray-100 dark:bg-gray-700 rounded-lg">
                            ...
                            @if ($structure)
                                ...
                                @if (isset($structure['summary']))
                                    <div class="mb-4">
                                        <h5 class="font-semibold text-gray-700 dark:text-gray-300">要約：</h5>
                                        <p class="text-gray-800 dark:text-gray-200 leading-relaxed">{{ $structure['summary'] }}
                                        </p>
                                    </div>
                                @endif
                                ...
                                @if (isset($structure['point']))
                                    <div class="mb-4">
                                        <h5 class="font-semibold text-gray-700 dark:text-gray-300">ポイント：</h5>
                                ...
                                @if (isset($structure['next-action']))
                                    <div class="mb-4">
                                        <h5 class="font-semibold text-gray-700 dark:text-gray-300">次のアクション：</h5>
                                        <ul class="list-disc pl-5">
                                ...
                                @endif
                            @else
                                <p class="text-gray-800 dark:text-gray-200">構造化データがありません。</p>
                            @endif
                        </div>
                    </div>
