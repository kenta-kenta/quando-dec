            ...
            <div class="bg-white bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 text-gray-100">
                    ...
                    <form action="{{ route('contents.index') }}" method="GET" class="mb-6">
                        <div class="flex w-[90%] mx-auto gap-4">
                            <input type="text" name="query"
                                class="flex-1 shadow appearance-none border rounded py-2 px-3 text-gray-700 text-gray-300 bg-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    ...
                    @if(request('query'))
                        <!-- 検索結果 -->
                        <div class="mb-6">
                            <h3 class="text-lg font-bold text-gray-700 text-gray-300 mb-4">
                            ...
                            @if ($searchResults->count())
                                @foreach ($searchResults as $content)
                                    <div
                                        class="mb-4 p-4 bg-gray-100 bg-gray-700 rounded-lg border border-gray-300 border-gray-600">
                                        <p class="text-gray-800 text-gray-300 font-bold">{{ $content->title }}</p>
                                        <p class="text-gray-600 text-gray-400 text-sm">作成日:
                            ...
                            @else
                                <p class="text-red-500 text-red-400">検索結果が見つかりませんでした。</p>
                            @endif
                    ...
                    <!-- その他のコンテンツ -->
                    <h3 class="text-lg font-bold text-gray-700 text-gray-300 mt-8 mb-4">
