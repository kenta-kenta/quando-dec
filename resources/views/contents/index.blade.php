            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-6">
                        ...
                        <div
                            class="mb-4 p-4 bg-gray-100 rounded-lg border border-gray-300">
                            <p class="text-gray-800 font-bold">{{ $content->title }}</p>
                            <p class="text-gray-600 text-sm">作成日:
                        ...
                        @else
                        <p class="text-red-500">検索結果が見つかりませんでした。</p>
                        @endif
                    ...
                    <!-- その他のコンテンツ -->
                    <h3 class="text-lg font-bold text-gray-700 mt-8 mb-4">
