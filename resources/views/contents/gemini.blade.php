            ...
            <div class="bg-white bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 text-gray-100">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="bg-gray-100 bg-gray-700 rounded-lg p-4">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="space-y-6 bg-gray-50 bg-gray-700 rounded-lg p-6 shadow-sm">
                            <form method="POST" action="{{ route('contents.update', $content->id) }}">
                                ...
                                <div class="border-b pb-4 border-gray-600">
                                    <h4 class="font-semibold text-gray-700 text-gray-300 mb-2">タイトル：</h4>
                                    <input type="text" name="title" value="{{ old('title', $json['title'] ?? '') }}"
                                        class="w-full p-2 bg-gray-100 bg-gray-700 text-gray-900 text-gray-100 rounded-md border border-gray-300 border-gray-600 focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                                ...
                                <div class="border-b pb-4 border-gray-600">
                                    ...
                                    <textarea name="summary"
                                        class="w-full p-2 bg-gray-100 bg-gray-700 text-gray-900 text-gray-100 rounded-md border border-gray-300 border-gray-600 focus:ring-indigo-500 focus:border-indigo-500">{{ old('summary', $json['summary'] ?? '') }}</textarea>
                                </div>

                                <!-- ポイント -->
                                <div class="border-b pb-4 border-gray-600" id="points">
                                    <h4 class="font-semibold text-gray-700 text-gray-300 mb-2">ポイント：</h4>
                                    @if (empty($json['point']))
                                    ...
                                    @endif
                                    <button type="button"
                                        class="inline-flex items-center px-4 py-2 bg-gray-800 bg-gray-200 text-white text-gray-800 font-semibold rounded-md hover:bg-gray-700 hover:bg-white focus:bg-gray-700 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-800 transition ease-in-out duration-150"
                                        id="add-point">
                                        ポイントを追加
                                    </button>
                                </div>
                                ...
                                <!-- 次のアクション -->
                                <div id="next-actions">
                                    <h4 class="font-semibold text-gray-700 text-gray-300 mb-2">次のアクション：</h4>
                    ...
                    <div class="mt-6 flex justify-between items-center">
                        ...
                        <button type="button" onclick="deleteContentAndRedirect()"
                            class="inline-flex items-center px-4 py-2 bg-gray-800 bg-gray-200 border border-transparent rounded-md font-semibold text-xs text-white text-gray-800 uppercase tracking-widest hover:bg-gray-700 hover:bg-white focus:bg-gray-700 focus:bg-white active:bg-gray-900 active:bg-gray-300">
                            戻る
                        </button>
                    </div>
                </div>
