                        ...
                        <div class="space-y-6 bg-gray-50 rounded-lg p-6 shadow-sm">
                            <form method="POST" action="{{ route('contents.update', $content->id) }}">
                                ...
                                <div class="border-b pb-4" id="points">
                                    ...
                                    @endif
                                    <button type="button"
                                        class="inline-flex items-center px-4 py-2 bg-gray-800 text-white font-semibold rounded-md hover:bg-gray-700 focus:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150"
                                        id="add-point">
                                        ポイントを追加
                                    </button>
                                </div>
